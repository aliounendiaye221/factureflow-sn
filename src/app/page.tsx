  ...
  return (
    <div className="min-h-screen bg-white font-sans selection:bg-blue-100">
      ...
      <nav className="fixed top-0 left-0 right-0 bg-white/80 backdrop-blur-lg z-50 border-b border-gray-100/80 shadow-sm shadow-gray-100">
        <div className="max-w-7xl mx-auto px-6 h-18 flex items-center justify-between py-4">
          <div className="flex items-center gap-2.5">
            <div className="w-9 h-9 rounded-xl bg-gradient-to-br from-blue-600 to-blue-700 flex items-center justify-center text-white font-black text-lg shadow-lg shadow-blue-500/30">F</div>
            <span className="text-xl font-bold tracking-tight text-gray-900">FactureFlow <span className="text-blue-600">SN</span></span>
          </div>
          ...
          <div className="flex items-center gap-3">
            ...
            <Link href="/login">
              <Button className="bg-blue-600 hover:bg-blue-700 shadow-lg shadow-blue-500/25 font-semibold px-5">
      ...
      <main>
        ...
        {/* ── Hero ── */}
        <section className="relative pt-36 pb-24 md:pt-48 md:pb-32 overflow-hidden px-6">
          ...
          <div className="relative max-w-5xl mx-auto text-center space-y-8">
            ...
            <h1 className="text-5xl md:text-7xl font-black text-gray-900 tracking-tight leading-[1.08]">
              De la commande au paiement <br />
            ...
            <div className="flex flex-col sm:flex-row items-center justify-center gap-4 pt-4">
              <Link href="/login" className="w-full sm:w-auto">
                <Button size="lg" className="w-full sm:w-auto bg-blue-600 hover:bg-blue-700 text-lg px-10 h-16 rounded-2xl shadow-2xl shadow-blue-500/30 hover:scale-105 transition-transform font-bold">
                  Créer un compte gratuit
                  <ArrowRight className="ml-2 w-5 h-5" />
                </Button>
              </Link>
              <a href="#features" className="w-full sm:w-auto">
                <Button variant="outline" size="lg" className="w-full sm:w-auto h-16 rounded-2xl text-lg font-semibold border-gray-200 hover:bg-gray-50">
          ...
          <div className="max-w-5xl mx-auto">
            ...
            <div className="grid md:grid-cols-3 gap-6 items-center">
              {PLANS.map((plan) => (
                <div
                  key={plan.name}
                  className={`relative rounded-3xl p-8 flex flex-col gap-6 bg-white transition-all ${plan.highlight
                    ? 'border-2 border-blue-600 shadow-xl shadow-blue-500/10 scale-105 md:scale-110 z-10'
        ...
        <section className="py-28 px-6 bg-white">
          <div className="max-w-4xl mx-auto bg-gradient-to-br from-blue-600 to-blue-700 rounded-3xl p-12 md:p-20 text-center relative overflow-hidden shadow-2xl shadow-blue-500/30">
            ...
            <h2 className="text-3xl md:text-5xl font-black text-white mb-6 relative z-10 tracking-tight">
              Commencez à encaisser<br />plus vite dès aujourd'hui
            </h2>
            ...
            <Link href="/login" className="relative z-10 inline-block">
              <Button size="lg" className="bg-white text-blue-600 hover:bg-gray-50 h-16 px-12 rounded-2xl text-lg font-bold shadow-xl hover:scale-105 transition-transform">
      ...
      {/* ── Footer ── */}
      <footer className="bg-gray-950 border-t border-gray-800 py-14 px-6">
